...
function transacaoNoEstoque(origem, destino, tipo, quantidade) {
    ...
    if(destino === "pomar"){
        dePessoaParaPomar(origem, quantidade, tipo);
        return;
    }

    if(origem === "pomar"){
        dePomarParaPessoa(destino, quantidade, tipo);
        return;
    }
...
function dePomarParaPessoa(destino, quantidade, tipo){
...
function dePessoaParaPomar(origem, quantidade, tipo){
